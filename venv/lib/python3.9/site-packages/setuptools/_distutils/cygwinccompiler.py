...
#   - using gcc -mdll instead dllwrap doesn't work without -static1 because
#     it tries to link against dlls instead their import libraries. (If
#     it finds the dll first.)
#     By specifying -static1 we force ld to link against the import libraries,
